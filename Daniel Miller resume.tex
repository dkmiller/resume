...
\cventry
	...
	{
		\begin{cvitems}
			\item{Spearheaded the productionization of a framework for compiling conceptual descriptions of statistical tests to code for computing their values and standard deviations in Apache Spark.}
			...
			\item{Developed a framework for metric lifecycle for Bing.}
